...
(() => {
    ...
    config.images = (() => {
        ...
        let images = {
            ...
            enemyStone: path + 'enemyStone.png',
            fuel: path + 'fuel2.png',
        };

        return Object.assign(
            batchAdd(path+'/sea-objects/','object_',12,'png'),
            batchAdd(path+'/seaStones/','seaStones_',4,'png'),
            images,
        )
